...
import { StatusesIndexResponse } from '../model/statusesIndexResponse';
import { StatusesLastResponse } from '../model/statusesLastResponse';
...
export class DefaultService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public statusesHashtagHashtagGet(pageSize: string, startIndex: string, hashtag: string, observe?: 'body', reportProgress?: boolean): Observable<StatusesIndexResponse>;
    public statusesHashtagHashtagGet(pageSize: string, startIndex: string, hashtag: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<StatusesIndexResponse>>;
    public statusesHashtagHashtagGet(pageSize: string, startIndex: string, hashtag: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<StatusesIndexResponse>>;
    public statusesHashtagHashtagGet(pageSize: string, startIndex: string, hashtag: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (startIndex === null || startIndex === undefined) {
            throw new Error('Required parameter startIndex was null or undefined when calling statusesHashtagHashtagGet.');
        }
        ...
        return this.httpClient.get<StatusesIndexResponse>(`${this.basePath}/statuses/hashtag/${encodeURIComponent(String(hashtag))}`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public usersHandleFeedGet(pageSize: string, startIndex: string, handle: string, observe?: 'body', reportProgress?: boolean): Observable<StatusesIndexResponse>;
    public usersHandleFeedGet(pageSize: string, startIndex: string, handle: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<StatusesIndexResponse>>;
    public usersHandleFeedGet(pageSize: string, startIndex: string, handle: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<StatusesIndexResponse>>;
    public usersHandleFeedGet(pageSize: string, startIndex: string, handle: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (startIndex === null || startIndex === undefined) {
            throw new Error('Required parameter startIndex was null or undefined when calling usersHandleFeedGet.');
        }
        ...
        return this.httpClient.get<StatusesIndexResponse>(`${this.basePath}/users/${encodeURIComponent(String(handle))}/feed`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public usersHandleStoryGet(pageSize: string, handle: string, ownerHandle?: string, id?: string, observe?: 'body', reportProgress?: boolean): Observable<StatusesLastResponse>;
    public usersHandleStoryGet(pageSize: string, handle: string, ownerHandle?: string, id?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<StatusesLastResponse>>;
    public usersHandleStoryGet(pageSize: string, handle: string, ownerHandle?: string, id?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<StatusesLastResponse>>;
    public usersHandleStoryGet(pageSize: string, handle: string, ownerHandle?: string, id?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<StatusesLastResponse>(`${this.basePath}/users/${encodeURIComponent(String(handle))}/story`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
