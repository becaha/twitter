 ...
 *
 * OpenAPI spec version: 2019-11-01T01:02:47Z
 *
 *
...
export class DefaultService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public statusesHashtagHashtagGet(hashtag: string, observe?: 'body', reportProgress?: boolean): Observable<StatusesResponse>;
    public statusesHashtagHashtagGet(hashtag: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<StatusesResponse>>;
    public statusesHashtagHashtagGet(hashtag: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<StatusesResponse>>;
    public statusesHashtagHashtagGet(hashtag: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<StatusesResponse>(`${this.basePath}/statuses/hashtag/${encodeURIComponent(String(hashtag))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public statusesHashtagHashtagOptions(observe?: 'body', reportProgress?: boolean): Observable<Empty>;
    public statusesHashtagHashtagOptions(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Empty>>;
    public statusesHashtagHashtagOptions(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Empty>>;
    public statusesHashtagHashtagOptions(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.options<Empty>(`${this.basePath}/statuses/hashtag/${encodeURIComponent(String('hashtag'))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
