...
export class DefaultService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public followUserHandleFollowHandlePost(followHandle: string, userHandle: string, followRequest: FollowRequest, observe?: 'body', reportProgress?: boolean): Observable<Response>;
    public followUserHandleFollowHandlePost(followHandle: string, userHandle: string, followRequest: FollowRequest, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Response>>;
    public followUserHandleFollowHandlePost(followHandle: string, userHandle: string, followRequest: FollowRequest, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Response>>;
    public followUserHandleFollowHandlePost(followHandle: string, userHandle: string, followRequest: FollowRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (followRequest === null || followRequest === undefined) {
            throw new Error('Required parameter followRequest was null or undefined when calling followUserHandleFollowHandlePost.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public followUserHandleFollowHandleUnfollowPost(followHandle: string, userHandle: string, followRequest: FollowRequest, observe?: 'body', reportProgress?: boolean): Observable<Response>;
    public followUserHandleFollowHandleUnfollowPost(followHandle: string, userHandle: string, followRequest: FollowRequest, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Response>>;
    public followUserHandleFollowHandleUnfollowPost(followHandle: string, userHandle: string, followRequest: FollowRequest, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Response>>;
    public followUserHandleFollowHandleUnfollowPost(followHandle: string, userHandle: string, followRequest: FollowRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (followRequest === null || followRequest === undefined) {
            throw new Error('Required parameter followRequest was null or undefined when calling followUserHandleFollowHandleUnfollowPost.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public usersHandleLoginPost(handle: string, loginRequest: LoginRequest, observe?: 'body', reportProgress?: boolean): Observable<UserResponse>;
    public usersHandleLoginPost(handle: string, loginRequest: LoginRequest, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<UserResponse>>;
    public usersHandleLoginPost(handle: string, loginRequest: LoginRequest, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<UserResponse>>;
    public usersHandleLoginPost(handle: string, loginRequest: LoginRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (handle === null || handle === undefined) {
            throw new Error('Required parameter handle was null or undefined when calling usersHandleLoginPost.');
        }

        if (loginRequest === null || loginRequest === undefined) {
            throw new Error('Required parameter loginRequest was null or undefined when calling usersHandleLoginPost.');
        }
        ...
        return this.httpClient.post<UserResponse>(`${this.basePath}/users/${encodeURIComponent(String(handle))}/login`,
            loginRequest,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public usersHandleSignupPost(handle: string, signupRequest: SignupRequest, observe?: 'body', reportProgress?: boolean): Observable<UserResponse>;
    public usersHandleSignupPost(handle: string, signupRequest: SignupRequest, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<UserResponse>>;
    public usersHandleSignupPost(handle: string, signupRequest: SignupRequest, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<UserResponse>>;
    public usersHandleSignupPost(handle: string, signupRequest: SignupRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<UserResponse>(`${this.basePath}/users/${encodeURIComponent(String(handle))}/signup`,
            signupRequest,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
